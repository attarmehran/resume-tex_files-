...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\LARGE Mehran Attar}} \\
  Ph.D. Research Scientist
\end{tabular*}
%
\begin{multicols}{2}
  Location: Montreal, Quebec, Canada\\
  Email address: \href{mailto:mehran.attar@gmail.com}{mehran.attar@gmail.com}\\
...
\section{Summary}
\justifying
Ph.D. Researcher with experience in machine learning, cybersecurity, and control systems engineering. Adept at conducting cutting-edge research in data-driven methods for cyber-physical systems security, with a strong focus on safety and performance under network attacks. Skilled in programming languages ({\color{blue}Python, C, MATLAB}) and machine learning and deep learning tools ({\color{blue}Scikit-learn, PyTorch}), with a passion for solving complex problems through data-driven methods and advanced control techniques.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection*{Industrial Experiences}
  ...
  \resumeSubHeadingListStart
    ...
    {Machine Learning Researcher}{Jan. 2024 - Present}
      {\href{https://www.ericsson.com/en}{Ericsson Canada}}{Montreal, Canada}
      {\small
	   \begin{itemize}
            \item Develop quantum-inspired algorithms to solve constrained optimization problems 
            %
            \item Develop a Signed Particle Formulation of Quantum Mechanics to enhance the parallelization computation capacity of Deep Neural Networks (DNNs) training process.
            \item Design data-driven control architectures to preserve the safety and security of constrained cyber-physical systems using QiML-based methods
	   \end{itemize}
  ...
  %%%
    ...
    \resumeSubheading
      ...
      {\href{https://users.encs.concordia.ca/~wlucia/Group.html}{Cyber-Physical Systems Security Research Group}}{Montreal, Canada}
	   ...
	   \begin{itemize}
     %
	       \item Develop data-driven methods for the safety and security of constrained cyber-physical systems (Ph.D. research)     
	 \end{itemize}
	   }
	   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	   \resumeSubheading
...
%          1455 de Maisonneuve Blvd. West, EV9.185 Montreal, Quebec, Canada, H3G 1M8\\
%          Phone: (514) 848-2424 ext. 3982\\
%          Email: \href{mailto: walter.lucia@concordia.ca}{ walter.lucia@concordia.ca}
%          %
%         \item \href{https://users.encs.concordia.ca/~kash/}{\textbf{Prof. Kash Khorasani}}\\
%          Department of Electrical and Computer Engineering, Concordia University\\
%          1455 de Maisonneuve Blvd. West, EV5.125 Montreal, Quebec, Canada, H3G 1M8\\
%          Phone: (514) 848-2424 ext. 3086\\
%          Email: \href{kash@ece.concordia.ca}{ kash@ece.concordia.ca}
%          %
