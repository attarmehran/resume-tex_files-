...
\subsection*{Industrial Experiences}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
    {Applied Machine Learning Intern}{Jan. 2024 - Present}
      {\href{https://www.ericsson.com/en}{Ericsson}}{Montreal, Canada}
      
	   
    %%%%%
    \resumeSubheading
      {Applied Industrial Machine Learning Research Scientist}{April 2017 - Aug. 2021}
